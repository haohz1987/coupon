...
public class CouponAdapter extends BaseRecyclerViewAdapter<CouponBean.ResultBean> {
...
//        return null;
    ...
    private class ViewHolder extends BaseRecyclerViewHolder<CouponBean.ResultBean, ItemCouponBinding> {
        ...
        @Override
        public void onBindViewHolder(final CouponBean.ResultBean resultBean, final int position) {
            ...
            GlideUtils.readCache(activity,
                    ...
                    resultBean.getLogo(),      //网址
                    mACache,                        //缓存工具
                    resultBean.getCoupTitle());     //缓存名称-商户名
