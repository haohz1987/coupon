package com.handpay.coupon.view.statusbar;
...
public class ActionBar {
	...
	//右边控件的点击事件
	public OnClickListener rightOnListener;
	...
	public ActionBar(String title,boolean isLeftShow,Object rightView,OnClickListener rightOnListener){
		super();
		this.title = title;
		this.isLeftShow = isLeftShow;
		if(rightView != null){
		...
		this.rightOnListener = rightOnListener;
	}
