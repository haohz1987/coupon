...
public class GridImageView<TImage> extends ViewGroup {
    ...
    private List<TImage> mImgDataList=new ArrayList<>();
     ...
     */
    public void setImageData(List<TImage> lists, boolean clearLastData) {
     ...
     * @param adapter 适配器
     */
    public void setAdapter(GridImageViewAdapter<TImage> adapter) {
        mAdapter = adapter;
    ...
    public void add(TImage t){
        mImgDataList.add(t);
        refreshDataSet();
    }

    public void addAll(List<TImage> l){
