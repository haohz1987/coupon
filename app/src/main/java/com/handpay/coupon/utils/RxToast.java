...
import static com.handpay.coupon.CpApp.mContext;
...
public class RxToast {
    ...
    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(mContext, message, getDrawable(mContext, R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(mContext, message, getDrawable(mContext, R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(mContext, message, getDrawable(mContext, R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(mContext, message, getDrawable(mContext, R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
